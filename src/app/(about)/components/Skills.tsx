        ...
        <div className="rounded-lg p-4 shadow-lg">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
                {items.map(({ name, icon: Icon }) => (
                    ...
                    >
                        <Icon className="w-10 h-10 md:w-14 md:h-14 mb-2 text-cyan-700 hover:text-cyan-400 transition-all duration-300 icon-wobble" />
                        <span className="absolute bottom-full mb-2 inline-block px-2 py-1 text-xs text-white bg-gradient-to-r bg-cyan-700 rounded-lg transform scale-75 opacity-0 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 ease-out shadow-lg whitespace-nowrap">
                            {name}
                        </span>
                    </div>
                ))}
